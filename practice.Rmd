...
Functional originality indices are computed on a species basis and
not per sites.

SCHEME OF Di AND Ui

Functional distinctiveness is weighted mean of dissimilarity.

functional uniqueness is the nearest neigbhour.
