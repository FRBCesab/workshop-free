...
To compute uniqueness at regional scale we also need the regional level functional dissimilarity matrix with the `uniqueness()` function, and the site-species
atrix:
...
tool you prefer to plot the metrics.

Visualization in a functional space. Regional visualization. Color the points
in function of regional distinctiveness and regional uniqueness.

What traits are driving regional distinctiveness?

Visualization of local communities, visualize the distribution in variation of
distinctiveness in local community.
