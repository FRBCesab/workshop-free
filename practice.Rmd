...
## Part 2 - Computing functional originality indices with `funrar`

In this part we'll be using our built functional space to compute functional
originality indices.

SHORT EXPLANATION OF FUNCTIONAL ORIGINALITY + FIGURE + CITE SEMINAL PAPERS


### Where are species distributed?

Creating a (fake) site-species matrix for our dataset.


### Different indices of functional originality

Functional distinctiveness, functional uniqueness.


### Computing functional originality
...
### Plotting functional originality
