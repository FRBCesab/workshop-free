...
Click on _base_
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Click on _Download R 4.1.3 for Windows_
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Open _R-4.1.3-win.exe_ and follow instructions
...
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Open _RStudio-2022.02.1-461.exe_ and follow instructions
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
...
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Open _Git-2.35.1-64-bit.exe_ and follow instructions
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
...
4. Download **`Rtools4.0`** at:<br/>
[https://cran.r-project.org/bin/windows/Rtools/rtools40.html](https://cran.r-project.org/bin/windows/Rtools/rtools40.html)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Download the 64-bit version for Windows
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Open _rtools40-x86_64.exe_ and follow instructions

The installation of **`Rtools4.0`** is optional, but this software is required
to install packages (from sources) containing compiled code (C/C++/Fortran). 
**`Rtools4.0`** contains in particular the utility `make`.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Once **`Rtools4.0`** is installed, you need to tell `r fontawesome::fa_i("r-project")` 
where to find **`Rtools4.0`** utilities.
Open **`RStudio`** et run:
...
For the workshop, you will need to install the following R packages:
...
```sh
## URL HTTPS ----
https://github.com/rdatatoolbox/rdatatoolbox.github.io.git

## URL SSH (use this one) ----
git@github.com:rdatatoolbox/rdatatoolbox.github.io.git
```
